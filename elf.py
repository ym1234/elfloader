...
#
# clang2py -k acdefmstu /usr/include/elf.h -o elf.py
import ctypes
...
#    return ((unsignedchar)(info))
# def ELF32_M_INFO(sym, size):  # macro
#    return (((sym)<<8)+(unsignedchar)(size))
# def ELF64_M_SYM(info):  # macro
#    return ((info)>>8)(info)
# def ELF64_M_SIZE(info):  # macro
#    return ((unsignedchar)(info))(info)
# def ELF64_M_INFO(sym, size):  # macro
#    return (((sym)<<8)+(unsignedchar)(size))(sym,size)
...
class struct_Elf32_Dyn(Structure):
    pass

class union_Elf32_Dyn_d_un(Union):
    pass

union_Elf32_Dyn_d_un._pack_ = 1 # source:False
union_Elf32_Dyn_d_un._fields_ = [
    ('d_val', ctypes.c_uint32),
    ('d_ptr', ctypes.c_uint32),
]

struct_Elf32_Dyn._pack_ = 1 # source:False
struct_Elf32_Dyn._fields_ = [
    ('d_tag', ctypes.c_int32),
    ('d_un', union_Elf32_Dyn_d_un),
]

Elf32_Dyn = struct_Elf32_Dyn
class struct_Elf64_Dyn(Structure):
    pass

class union_Elf64_Dyn_d_un(Union):
    pass

union_Elf64_Dyn_d_un._pack_ = 1 # source:False
union_Elf64_Dyn_d_un._fields_ = [
    ('d_val', ctypes.c_uint64),
    ('d_ptr', ctypes.c_uint64),
]

struct_Elf64_Dyn._pack_ = 1 # source:False
struct_Elf64_Dyn._fields_ = [
    ('d_tag', ctypes.c_int64),
    ('d_un', union_Elf64_Dyn_d_un),
]

Elf64_Dyn = struct_Elf64_Dyn
...
class struct_Elf32_auxv_t(Structure):
    pass

class union_Elf32_auxv_t_a_un(Union):
    pass

union_Elf32_auxv_t_a_un._pack_ = 1 # source:False
union_Elf32_auxv_t_a_un._fields_ = [
    ('a_val', ctypes.c_uint32),
]

struct_Elf32_auxv_t._pack_ = 1 # source:False
struct_Elf32_auxv_t._fields_ = [
    ('a_type', ctypes.c_uint32),
    ('a_un', union_Elf32_auxv_t_a_un),
]

Elf32_auxv_t = struct_Elf32_auxv_t
class struct_Elf64_auxv_t(Structure):
    pass

class union_Elf64_auxv_t_a_un(Union):
    pass

union_Elf64_auxv_t_a_un._pack_ = 1 # source:False
union_Elf64_auxv_t_a_un._fields_ = [
    ('a_val', ctypes.c_uint64),
]

struct_Elf64_auxv_t._pack_ = 1 # source:False
struct_Elf64_auxv_t._fields_ = [
    ('a_type', ctypes.c_uint64),
    ('a_un', union_Elf64_auxv_t_a_un),
]

Elf64_auxv_t = struct_Elf64_auxv_t
...
class union_Elf32_gptab(Union):
    pass

class struct_Elf32_gptab_gt_header(Structure):
    pass

struct_Elf32_gptab_gt_header._pack_ = 1 # source:False
struct_Elf32_gptab_gt_header._fields_ = [
    ('gt_current_g_value', ctypes.c_uint32),
    ('gt_unused', ctypes.c_uint32),
]

class struct_Elf32_gptab_gt_entry(Structure):
    pass

struct_Elf32_gptab_gt_entry._pack_ = 1 # source:False
struct_Elf32_gptab_gt_entry._fields_ = [
    ('gt_g_value', ctypes.c_uint32),
    ('gt_bytes', ctypes.c_uint32),
]

union_Elf32_gptab._pack_ = 1 # source:False
union_Elf32_gptab._fields_ = [
    ('gt_header', struct_Elf32_gptab_gt_header),
    ('gt_entry', struct_Elf32_gptab_gt_entry),
]

Elf32_gptab = union_Elf32_gptab
...
__all__ = \
    ...
    'AT_ICACHEBSIZE', 'AT_IGNORE', 'AT_IGNOREPPC',
    'AT_L1D_CACHEGEOMETRY', 'AT_L1D_CACHESHAPE', 'AT_L1D_CACHESIZE',
    'AT_L1I_CACHEGEOMETRY', 'AT_L1I_CACHESHAPE', 'AT_L1I_CACHESIZE',
    'AT_L2_CACHEGEOMETRY', 'AT_L2_CACHESHAPE', 'AT_L2_CACHESIZE',
    'AT_L3_CACHEGEOMETRY', 'AT_L3_CACHESHAPE', 'AT_L3_CACHESIZE',
    'AT_MINSIGSTKSZ', 'AT_NOTELF', 'AT_NULL', 'AT_PAGESZ', 'AT_PHDR',
    'AT_PHENT', 'AT_PHNUM', 'AT_PLATFORM', 'AT_RANDOM',
    'AT_RSEQ_ALIGN', 'AT_RSEQ_FEATURE_SIZE', 'AT_SECURE',
    ...
    'DT_PPC_OPT', 'DT_PREINIT_ARRAY', 'DT_PREINIT_ARRAYSZ', 'DT_REL',
    'DT_RELA', 'DT_RELACOUNT', 'DT_RELAENT', 'DT_RELASZ',
    'DT_RELCOUNT', 'DT_RELENT', 'DT_RELR', 'DT_RELRENT', 'DT_RELRSZ',
    'DT_RELSZ', 'DT_RISCV_VARIANT_CC', 'DT_RPATH', 'DT_RUNPATH',
    'DT_SONAME', 'DT_SPARC_NUM', 'DT_SPARC_REGISTER', 'DT_STRSZ',
    'DT_STRTAB', 'DT_SYMBOLIC', 'DT_SYMENT', 'DT_SYMINENT',
    'DT_SYMINFO', 'DT_SYMINSZ', 'DT_SYMTAB', 'DT_SYMTAB_SHNDX',
    'DT_TEXTREL', 'DT_TLSDESC_GOT', 'DT_TLSDESC_PLT', 'DT_VALNUM',
    'DT_VALRNGHI', 'DT_VALRNGLO', 'DT_VERDEF', 'DT_VERDEFNUM',
    'DT_VERNEED', 'DT_VERNEEDNUM', 'DT_VERSIONTAGNUM', 'DT_VERSYM',
    'DT_X86_64_NUM', 'DT_X86_64_PLT', 'DT_X86_64_PLTENT',
    'DT_X86_64_PLTSZ', 'EFA_PARISC_1_0', 'EFA_PARISC_1_1',
    ...
    'EF_IA_64_ARCH', 'EF_IA_64_MASKOS', 'EF_LARCH_ABI_DOUBLE_FLOAT',
    ...
    'LL_NONE', 'LL_REQUIRE_MINOR', 'MIPS_AFL_ASE_DSP',
    ...
    'PPC_OPT_TLS', 'PT_AARCH64_MEMTAG_MTE', 'PT_ARM_EXIDX',
    'PT_DYNAMIC', 'PT_GNU_EH_FRAME', 'PT_GNU_PROPERTY',
    'PT_GNU_RELRO', 'PT_GNU_SFRAME', 'PT_GNU_STACK', 'PT_HIOS',
    ...
    'R_NIOS2_TLS_TPREL', 'R_NIOS2_U16', 'R_NIOS2_UJMP', 'R_OR1K_16',
    'R_OR1K_16_PCREL', 'R_OR1K_32', 'R_OR1K_32_PCREL', 'R_OR1K_8',
    'R_OR1K_8_PCREL', 'R_OR1K_COPY', 'R_OR1K_GLOB_DAT',
    ...
    'R_X86_64_TPOFF32', 'R_X86_64_TPOFF64', 'SELFMAG', 'SHF_ALLOC',
    ...
    'SHT_ALPHA_DEBUG', 'SHT_ALPHA_REGINFO', 'SHT_ARC_ATTRIBUTES',
    ...
    'SHT_LOPROC', 'SHT_LOSUNW', 'SHT_LOUSER', 'SHT_MIPS_ABIFLAGS',
    'SHT_MIPS_AUXSYM', 'SHT_MIPS_CONFLICT', 'SHT_MIPS_CONTENT',
    'SHT_MIPS_DEBUG', 'SHT_MIPS_DELTACLASS', 'SHT_MIPS_DELTADECL',
    'SHT_MIPS_DELTAINST', 'SHT_MIPS_DELTASYM', 'SHT_MIPS_DENSE',
    'SHT_MIPS_DWARF', 'SHT_MIPS_EH_REGION', 'SHT_MIPS_EVENTS',
    'SHT_MIPS_EXTSYM', 'SHT_MIPS_FDESC', 'SHT_MIPS_GPTAB',
    'SHT_MIPS_IFACE', 'SHT_MIPS_LIBLIST', 'SHT_MIPS_LINE',
    'SHT_MIPS_LOCSTR', 'SHT_MIPS_LOCSYM', 'SHT_MIPS_MSYM',
    'SHT_MIPS_OPTIONS', 'SHT_MIPS_OPTSYM', 'SHT_MIPS_PACKAGE',
    'SHT_MIPS_PACKSYM', 'SHT_MIPS_PDESC', 'SHT_MIPS_PDR_EXCEPTION',
    'SHT_MIPS_PIXIE', 'SHT_MIPS_REGINFO', 'SHT_MIPS_RELD',
    'SHT_MIPS_RFDESC', 'SHT_MIPS_SHDR', 'SHT_MIPS_SYMBOL_LIB',
    'SHT_MIPS_TRANSLATE', 'SHT_MIPS_UCODE', 'SHT_MIPS_WHIRL',
    'SHT_MIPS_XHASH', 'SHT_MIPS_XLATE', 'SHT_MIPS_XLATE_DEBUG',
    'SHT_MIPS_XLATE_OLD', 'SHT_NOBITS', 'SHT_NOTE', 'SHT_NULL',
    'SHT_NUM', 'SHT_PARISC_DOC', 'SHT_PARISC_EXT',
    'SHT_PARISC_UNWIND', 'SHT_PREINIT_ARRAY', 'SHT_PROGBITS',
    'SHT_REL', 'SHT_RELA', 'SHT_RELR', 'SHT_RISCV_ATTRIBUTES',
    'SHT_SHLIB', 'SHT_STRTAB', 'SHT_SUNW_COMDAT', 'SHT_SUNW_move',
    'SHT_SUNW_syminfo', 'SHT_SYMTAB', 'SHT_SYMTAB_SHNDX',
    'SHT_X86_64_UNWIND', 'STB_GLOBAL', 'STB_GNU_UNIQUE', 'STB_HIOS',
    'STB_HIPROC', 'STB_LOCAL', 'STB_LOOS', 'STB_LOPROC',
    'STB_MIPS_SPLIT_COMMON', 'STB_NUM', 'STB_WEAK', 'STN_UNDEF',
    'STO_AARCH64_VARIANT_PCS', 'STO_ALPHA_NOPV',
    'STO_ALPHA_STD_GPLOAD', 'STO_MIPS_DEFAULT', 'STO_MIPS_HIDDEN',
    'STO_MIPS_INTERNAL', 'STO_MIPS_PLT', 'STO_MIPS_PROTECTED',
    'STO_MIPS_SC_ALIGN_UNUSED', 'STO_PPC64_LOCAL_BIT',
    'STO_PPC64_LOCAL_MASK', 'STO_RISCV_VARIANT_CC', 'STT_ARM_16BIT',
    'STT_ARM_TFUNC', 'STT_COMMON', 'STT_FILE', 'STT_FUNC',
    'STT_GNU_IFUNC', 'STT_HIOS', 'STT_HIPROC', 'STT_HP_OPAQUE',
    'STT_HP_STUB', 'STT_LOOS', 'STT_LOPROC', 'STT_NOTYPE', 'STT_NUM',
    'STT_OBJECT', 'STT_PARISC_MILLICODE', 'STT_SECTION',
    'STT_SPARC_REGISTER', 'STT_TLS', 'STV_DEFAULT', 'STV_HIDDEN',
    'STV_INTERNAL', 'STV_PROTECTED', 'SYMINFO_BT_LOWRESERVE',
    'SYMINFO_BT_PARENT', 'SYMINFO_BT_SELF', 'SYMINFO_CURRENT',
    'SYMINFO_FLG_COPY', 'SYMINFO_FLG_DIRECT', 'SYMINFO_FLG_LAZYLOAD',
    ...
    'Val_GNU_MIPS_ABI_FP_SOFT', 'Val_GNU_MIPS_ABI_FP_XX', '_ELF_H',
    'c__Ea_Val_GNU_MIPS_ABI_FP_ANY', 'struct_Elf32_Chdr',
    ...
    'struct_Elf32_auxv_t', 'struct_Elf32_gptab_gt_entry',
    'struct_Elf32_gptab_gt_header', 'struct_Elf64_Chdr',
    'struct_Elf64_Dyn', 'struct_Elf64_Ehdr', 'struct_Elf64_Lib',
    'struct_Elf64_Move', 'struct_Elf64_Nhdr', 'struct_Elf64_Phdr',
    'struct_Elf64_Rel', 'struct_Elf64_Rela', 'struct_Elf64_Shdr',
    'struct_Elf64_Sym', 'struct_Elf64_Syminfo',
    'struct_Elf64_Verdaux', 'struct_Elf64_Verdef',
    'struct_Elf64_Vernaux', 'struct_Elf64_Verneed',
    'struct_Elf64_auxv_t', 'struct_Elf_MIPS_ABIFlags_v0',
    'struct_Elf_Options', 'struct_Elf_Options_Hw',
    'union_Elf32_Dyn_d_un', 'union_Elf32_auxv_t_a_un',
    'union_Elf32_gptab', 'union_Elf64_Dyn_d_un',
    'union_Elf64_auxv_t_a_un']
